...
class home extends Component {
  ...
  render() {
    ...
    return (
      ...
      //   cityslideshow?
      //   <div>
      //  <h1 style={{color:'white',margin:'20px',fontSize:'30px'}}>Events in {this.props.city}</h1>
      //   <Slideshow eventtype={'search/' + this.props.city}  ></Slideshow><br></br><br></br> </div>:
      //   <div></div>
      // this.state.cityslideshow
        }
