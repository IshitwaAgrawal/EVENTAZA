...
public class ResponseUser {
  ...
  public ResponseUser(UUID id, String username, String name, String email, String roles,
      boolean newsletter_service, boolean organizer, List<EventModel> registeredEvents,
      List<EventModel> hostedEvents, List<EventModel> wishlist) {
    this.id = id;
